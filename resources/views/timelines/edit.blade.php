            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('spaces.show', $timeline->space ?? null) }}"
                            class="text-sm font-medium text-gray-500 hover:underline">{{ $timeline->space->name ?? 'スペース' }}</a>
                    </div>
                </li>
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-700">年表を編集</span>
                    </div>
                </li>
            </ol>
        </nav>

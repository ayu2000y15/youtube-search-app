                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('timelines.show', $timeline) }}"
                            class="text-sm font-medium text-gray-500 hover:underline">{{ $timeline->name }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-700">項目を追加</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    <form method="POST" action="{{ route('timelines.history-entries.store', $timeline) }}">
                        @include('history_entries._form', ['entry' => new \App\Models\HistoryEntry])
